...
def get_all_protocols():
	...
	protocols = [row[9] for row in rows if len(row)>0]
	return protocols
...
def load_sentence_2_vec(data_path="data"):
	...
	file_paths = ["/sentence_emb_800000.pt", "/sentence_emb_1600000.pt",
				  "/sentence_emb_2400000.pt",
				  "/sentence_emb_3200000.pt", "/sentence_emb_4000000.pt",
				  "/sentence_emb_4800000.pt", ]
